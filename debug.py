...
STATES = [State(name='IDLE', id=0, devices={'master': DeviceState(values={}, events=[]), 'tablet': DeviceState(values={}, events=[])}), State(name='BALLRAISE', id=1, devices={'master': DeviceState(values=OrderedDict([('stepperPosition', 'uint32_t')]), events=['demo', 'liftLeftWall', 'liftRightWall', 'lowerLeftWall', 'lowerRightWall', 'leftWall', 'rightWall']), 'tablet': DeviceState(values=OrderedDict(), events=['finishedAction'])}), State(name='OFF', id=2, devices={'master': DeviceState(values={}, events=[]), 'tablet': DeviceState(values={}, events=[])})]
